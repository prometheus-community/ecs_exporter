...
func NewFixtureCollectorStack(scope constructs.Construct, id string) awscdk.Stack {
	...
	awscdk.Validations_Of(stack).Acknowledge(&awscdk.Acknowledgment{
		Id:     jsii.String("CloudFormation-Validate::W2508"),
		Reason: jsii.String("We want to be able to ssh in from internet if needed"),
	})
...

	{
		...
		service := awsecs.NewFargateService(stack, jsii.String("FargateService"), &awsecs.FargateServiceProps{
